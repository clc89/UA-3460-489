...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(provideCourseContext:) name:@"provideCourseContext" object:nil];
...
- (void)provideCourseContext:(NSNotification *) notification {
    [[NSNotificationCenter defaultCenter] postNotificationName:@"courseContextProvided" object:self.managedObjectContext];
}
